...
const WebhookNode: React.FC<NodeProps<WebhookNodeData>> = ({ data, selected, id }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-success-100">
              <Send className="w-4 h-4 text-success-600" />
            </div>
        ...
        {/* Content */}
        <div className="text-xs text-neutral-600 line-clamp-2 font-mono mb-2">
          {data.url || 'Click to set webhook URL...'}
        </div>
