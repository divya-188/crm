...
const AssignmentNode: React.FC<NodeProps<AssignmentNodeData>> = ({ data, selected, id }) => {
      ...
      >
        ...
        <div className="text-xs text-neutral-600 mb-2">
          {data.agentName ? (
            <div className="flex items-center gap-2">
              <span>Assign to:</span>
              <span className="font-medium text-neutral-900">{data.agentName}</span>
            </div>
          ) : (
